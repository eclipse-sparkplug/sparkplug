...
public class DeviceConnect {
	...
	public void deviceCreate(String host_application_id) throws MqttException, InterruptedException {
		...
		String namespace="spAv1.0";
		String group_id ="group5";
		String edge_node_id ="node6";
