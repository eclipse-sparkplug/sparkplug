...
public class SessionEstablishmentTest extends TCKTest {
    ...
    public void connect(final @NotNull String clientId, final @NotNull ConnectPacket packet) {
        ...
        testResults.put(ID_PRINCIPLES_PERSISTENCE_CLEAN_SESSION, setResult(packet.getCleanStart(), PRINCIPLES_PERSISTENCE_CLEAN_SESSION));
        ...
        try {
            ...
            testResults.put(ID_PAYLOADS_NDEATH_WILL_MESSAGE, setResult(willPublishPacketOptional.isPresent(), PAYLOADS_NDEATH_WILL_MESSAGE));
        } catch (Exception e) {
    ...
    public void subscribe(final @NotNull String clientId, final @NotNull SubscribePacket packet) {
        ...
        for (Subscription s : subscriptions) {
            ...
            } else if (levels[0].equals(TOPIC_ROOT_STATE) && levels[1].equals(hostApplicationId)) {
                stateFound = true;
            }
        }
    }
    ...
    public void publish(final @NotNull String clientId, final @NotNull PublishPacket packet) {
        ...
        if (topicLevels[2].equals(TOPIC_PATH_NBIRTH)) {
            if (topicLevels[3].equals(edgeNodeId)) {
                ...
                testResults.put(ID_PRINCIPLES_BIRTH_CERTIFICATES_ORDER, setResult(bValid, PRINCIPLES_BIRTH_CERTIFICATES_ORDER));
            }
        }
    ...
    public void checkNBirth(final @NotNull PublishPacket packet) {
        ...
        if (sparkplugPayload != null) {
            ...
            for (Metric m : metrics) {
                ...
                } else if (bdSeqFound && rebirthFound) {
