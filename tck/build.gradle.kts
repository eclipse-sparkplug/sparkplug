...
val packageTck by tasks.registering {
    ...
    doLast {
        ...
        exec {
            commandLine = listOf("scp", "-o", "BatchMode=yes", "build/hivemq-extension/sparkplug-tck-3.0.0.jar", "genie.Sparkplug@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/Sparkplug/")
        }
        exec {
            commandLine = listOf("scp", "-o", "BatchMode=yes", "Eclipse-Sparkplug-TCK-3.0.0-signed.zip", "genie.Sparkplug@projects-storage.eclipse.org:/home/data/httpd/download.eclipse.org/Sparkplug/")
        }
    }
}
